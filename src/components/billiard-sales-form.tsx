...
export function BilliardSalesForm({
  ...
  return (
    <ActionForm action={saveTodayBilliardSales} className="grid gap-3 rounded-lg border bg-white p-4 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_auto]">
      ...
      <button className="min-h-11 self-end rounded-md bg-black px-5 font-bold text-[#d4af37]">
