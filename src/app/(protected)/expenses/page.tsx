...
export default async function ExpensesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <form action={createExpense} className="grid gap-3 rounded-lg border border-stone-300 bg-white p-4 md:grid-cols-[1fr_2fr_1fr_1fr_auto]">
