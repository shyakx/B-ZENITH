...
export const ROLE_NAV: Record<Role, NavItem[]> = {
  ...
  MANAGER: [
    ...
    { href: "/manager/products", label: "Products", hint: "Menu, categories & stock items" },
    { href: "/manager/inventory", label: "Stock", hint: "Receive, transfer & levels", group: "Inventory" },
    { href: "/manager/inventory/movements", label: "Stock History", hint: "All stock changes", group: "Inventory" },
    { href: "/manager/orders", label: "Orders", hint: "Every table order" },
    { href: "/manager/reports", label: "Reports", hint: "Sales, payments & history", group: "Reports" },
    { href: "/manager/maison", label: "Maison", hint: "Guest stay — not included in POS sales", group: "Reports" },
  ],
  ADMIN: [
    ...
    { href: "/manager/products", label: "Products", hint: "Menu, categories & stock items", group: "Catalog" },
    { href: "/manager/inventory", label: "Stock", hint: "Receive, transfer & levels", group: "Inventory" },
    { href: "/manager/inventory/movements", label: "Stock History", hint: "All stock changes", group: "Inventory" },
    { href: "/manager/inventory/suppliers", label: "Suppliers", hint: "Who we buy from", group: "Inventory" },
    { href: "/manager/reports", label: "Reports", hint: "Sales, payments & history", group: "Reports" },
    { href: "/manager/maison", label: "Maison", hint: "Guest stay — not included in POS sales", group: "Maison" },
